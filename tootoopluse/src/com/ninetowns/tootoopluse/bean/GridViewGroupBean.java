...
public class GridViewGroupBean implements Serializable {
	...
	public String toString() {
		return "GridViewGroupBean [GroupId=" + GroupId + ", Status=" + Status
				+ ", Members=" + Members + ", UserId=" + UserId + ", UserName="
				+ UserName + ", LogoUrl=" + LogoUrl + ", UserGrade="
				+ UserGrade + ", EatCode=" + EatCode + ", IsUsed=" + IsUsed
				+ ", IsAdmin=" + IsAdmin + "]";
	}
