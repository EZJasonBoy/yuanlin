...
public class TootooeNetApiUrlHelper extends ConstantsHelper {
	...
	public static final String CREATE_ACT_THIRD_STEP_SUBMIT_LATITUDE = "Latitude";
	public static final String CREATE_ACT_THIRD_STEP_SUBMIT_LONGITUDE = "Longitude";
	...
	/**地址列表---接口---参数**/
	public static final String ADDRESS_LIST_URL = "activitys/activityAddressList.htm?";
	public static final String ADDRESS_LIST_ACT_ID = "ActivityId";
    ...
    public static final String CATEGORY_PARENT_ID = "CategoryParentId";//商品父分类  (必填)
    ...
    /************活动首页****************/
    public static final String ACTIVITYS_MY_FREE_ACTIVITYSE="activitys/myFreeActivitiesE.htm?";
    public static final String STATUS="Status";//审核状态 1待审核2审核通过-1审核不通过，这里传值2  (必填)
    /******创建活动第二步******/
    ...
    /**活动或者心愿我的数据----接口---参数**/
    public final static String ACT_WISH_GET_DATA_URL = "activitys/GetMyData.htm?";
    public final static String ACT_WISH_GET_DATA_USERID = "UserId";
    public final static String ACT_WISH_GET_DATA_TYPE = "Type";
    public final static String ACT_WISH_GET_DATA_START_TIME_STAMP = "StartTimestamp";
    public final static String ACT_WISH_GET_DATA_END_TIME_STAMP = "EndTimestamp";
    public final static String ACT_WISH_GET_DATA_PAGE_SIZE = "PageSize";
    public final static String ACT_WISH_GET_DATA_PAGE = "Page";
    /***我的白吃团列表*****/
    
    public final static String MY_FREE_GROUP_URL = "group/GetBigEatSuccessList.htm?";
    /***我的白吃团成员成功的列表*****/
//    public final static String MY_FREE_GROUP_URL_MEMBER = "group/GetBigEatSuccessMember.htm?";
    /**我的白吃团成员列表 **/
    public final static String MY_FREE_GROUP_URL_MEMBER = "group/NewGetBigEatSuccessMember.htm?";
    public final static String MY_FREE_GROUP_URL_MEMBER_ACT = "ActivityId";
    /*****使用****/
    public final static String MY_USERDEAT = "group/UsedEat?.htm?";
    public final static String EatCode = "EatCode";
    /*********我的联系方式**************/
    public final static String GET_BIG_EAT_CONSTANCT="activitys/GetBigEatContactList.htm?";
    
//    http://www.tootoojia.com/group/UsedEat?GroupId=1454&ActivityId=2&UserId=100035
