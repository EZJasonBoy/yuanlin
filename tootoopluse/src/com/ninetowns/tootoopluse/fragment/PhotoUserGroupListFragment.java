...
public class PhotoUserGroupListFragment extends
	...
	public PhotoUserGroupListFragment(View viewDissMiss,String activityid,String countGroup,FragmentTransaction beginTransation) {
	...
	public RequestParamsNet getApiParmars() {
		...
		requestPar.addQueryStringParameter(TootooeNetApiUrlHelper.PAGE_SIZE,
				String.valueOf(TootooeNetApiUrlHelper.PAGESIZE_DRAFT_PHOTO));// 默认每页8条
	...
	public void getPageListParserResult(List<GridViewGroupBean> parserResult) {
		...
		if (wishList.size() > 0) {
			GridViewGroupPhotoAdapter wishAdatper = new GridViewGroupPhotoAdapter(getActivity(),
					wishList);
