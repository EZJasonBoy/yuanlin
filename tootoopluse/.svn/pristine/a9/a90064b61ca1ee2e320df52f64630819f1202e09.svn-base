...
import com.ninetowns.tootoopluse.fragment.HomePageFragment;
import com.ninetowns.tootoopluse.fragment.MineFragment;
import com.ninetowns.tootoopluse.fragment.ParentGroupChatFragment;
import com.ninetowns.tootoopluse.fragment.WishFragment;
...
public class HomeActivity extends FragmentGroupActivity implements
	...
	protected void onResume() {
		super.onResume();
		//test Channels
//		String stringchannel = AnalyticsConfig.getChannel(this);
			...
			if (null != object) {
				if (object.has("NoticeType")
					...
					mChatHandler.post(new Runnable() {
						...
						@Override
						public void run() {
							UIUtils.showCenterToast(HomeActivity.this,
									"您的账号已在别处登录");
						}
					});
					...
					mChatHandler.postDelayed(new Runnable() {
						...
						@Override
						public void run() {
							CommonUtil.exitApp(TootooPlusEApplication
									.getAppContext());
						}
					}, 1500);
					return;
