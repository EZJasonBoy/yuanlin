...
import com.ninetowns.tootoopluse.adapter.CityPostAresExpandAdapter;
import com.ninetowns.tootoopluse.adapter.HomePageAdapter.HomePageAdatperHolder;
...
public class HomePagerCityHelper implements OnChildClickListener {
	...
	public void setPopwindowPostCitys() {
		if (popWindowsub == null) {
			...
			int width = CommonUtil.getWidth(TootooPlusEApplication
					.getAppContext());
