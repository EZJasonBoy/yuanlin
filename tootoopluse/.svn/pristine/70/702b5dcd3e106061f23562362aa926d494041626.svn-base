...
public class CreateActTypeLvAdapter extends BaseAdapter{
	...
	public CreateActTypeLvAdapter(Context context, List<String> list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		create_act_down_item_tv.setText(list.get(position));
		return convertView;
	}
