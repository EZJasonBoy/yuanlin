...
public class ExpandTabViewHelper extends LinearLayout implements OnDismissListener {
	...
	public ExpandTabViewHelper(Context context) {
		super(context);
		init(context);
	}

	public ExpandTabViewHelper(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void showPopup(int position) {
		...
		if (tView instanceof ViewBaseActionHelper) {
			ViewBaseActionHelper f = (ViewBaseActionHelper) tView;
			f.show();
		}
	...
	private void init(Context context) {
		mContext = context;
		displayWidth =CommonUtil.getWidth(TootooPlusEApplication.getAppContext());
		displayHeight =CommonUtil.getHeight(TootooPlusEApplication.getAppContext());
