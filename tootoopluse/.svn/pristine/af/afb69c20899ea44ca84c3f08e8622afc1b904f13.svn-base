...
import com.ninetowns.tootoopluse.fragment.UpdateActFirstStepFragment;
import com.ninetowns.ui.Activity.FragmentGroupActivity;

public class UpdateActFirstStepActivity extends FragmentGroupActivity {
	...
	protected Class<? extends Fragment> getPrimaryFragmentClass(int fragmentId) {
		// TODO Auto-generated method stub
		return UpdateActFirstStepFragment.class;
	}
