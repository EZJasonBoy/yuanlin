...
/** 
* @ClassName: AndPointsRadioGroup 
* @Description: TODO 自定义RadioGroup实现 Radiobutton的切换 
* @author zhou
* @date 2015-1-22 下午1:55:28 
*  
*/
public class AndPointsRadioGroup extends LinearLayout {
	 ...
	 * {@inheritDoc}
	 */
	public AndPointsRadioGroup(Context context) {
		super(context);
		init();
	}
	 ...
	 * {@inheritDoc}
	 */
	public AndPointsRadioGroup(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
	...
	public LayoutParams generateLayoutParams(AttributeSet attrs) {
		return new AndPointsRadioGroup.LayoutParams(getContext(), attrs);
	}
	...
	protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
		return p instanceof AndPointsRadioGroup.LayoutParams;
	}
	...
	public interface OnCheckedChangeListener {
		 ...
		 */
		public void onCheckedChanged(AndPointsRadioGroup group, int checkedId);
	}
	...
	private class PassThroughHierarchyChangeListener implements
		...
		public void onChildViewAdded(View parent, View child) {
			if (parent == AndPointsRadioGroup.this) {
