package com.ninetowns.ui.cooldraganddrop;
...
//这个地方传入的参数如果是true那么会刷新
        mControlHeight = measureChildrens(true);
    ...
    protected void measureChildren(View child, final int width, final int height) {
        ...
        final int widthSpec;
        if (width == android.view.ViewGroup.LayoutParams.WRAP_CONTENT) {
    ...
    protected void startLongClickTransition(final View clickedChild) {
        ...
        if (clickedChild != null && mItemTransitionDrawable == null) {
        	if(clickedChild.getBackground().getCurrent() !=null){
        ...
        for (int position = 0; position < mAdapter.getCount(); position++) {
            ...
            if (childView == null) {
                ...
                if (params == null) {
                    ...
                    params = new LayoutParams(new AdapterView.LayoutParams(android.view.ViewGroup.LayoutParams.WRAP_CONTENT, android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
                }
