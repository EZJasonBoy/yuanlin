package com.ninetowns.ui.widget.listview.stickyheader;
...
public class StickyHeaderListView extends ListView {
	...
	private InternalAdapterWrapper.OnHeaderClickListener mAdapterHeaderClickListener = new InternalAdapterWrapper.OnHeaderClickListener() {
