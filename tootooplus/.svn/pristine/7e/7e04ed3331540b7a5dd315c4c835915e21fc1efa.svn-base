...
public class UIUtils {
	private static final float scale = TootooPlusApplication.getAppContext().getResources().getDisplayMetrics().density;  
	  
	private static final float scaledDensity = TootooPlusApplication.getAppContext().getResources().getDisplayMetrics().scaledDensity;  
	...
	public static void showProgressDialog(Context context, long total,
			long current) {
		if (null == mProgressDialog) {
			mProgressDialog = new ProgressDialog(context);
			mProgressDialog.setProgress((int) total);
		}
		mProgressDialog.setSecondaryProgress((int) current);
...
//						LayoutParams.WRAP_CONTENT);
	...
	*/
	...
	private static void requestViewFocus(View v) {
		v.setFocusable(true);
		v.setClickable(true);
	}
...
//		clearViewFocus(v);
	...
	private static void clearViewFocus(View v) {
