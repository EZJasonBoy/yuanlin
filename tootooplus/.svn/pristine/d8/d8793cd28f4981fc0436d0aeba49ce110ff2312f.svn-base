...
/**
 * 
* @ClassName: MyFreeCommentPassedFragment 
* @Description: 我的点评已通过
* @author wuyulong
* @date 2015-4-20 下午3:59:01 
*
 */
public class MyFreeCommentPassedFragment extends RemarkStoryFragment{
	...
	protected void setDiffientPar(RequestParamsNet requestParamsNet) {
		...
		requestParamsNet.addQueryStringParameter(TootooeNetApiUrlHelper.TYPE, "1");//审核未通过
	}
	@Override
	...
	protected void setFreeAdapter(RefreshableListView remark_story_lv,
		...
		MyFreeCommentAdapter adapter=new MyFreeCommentAdapter(getActivity(), parserResult);
