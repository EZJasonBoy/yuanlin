...
public class CreateActThirdStepActivity extends BaseActivity implements OnGetGeoCoderResultListener{
	...
	private void init(){
			...
			public void onClick(View v) {
				...
				if(act_line_type.equals("0")){
					...
					if(create_act_third_person_num.getText().toString().trim().equals("")){
						...
						ComponentUtil.showToast(CreateActThirdStepActivity.this, getResources().getString(R.string.create_act_per_num_less_100));
		...
		//组装两种组团方式
		final List<String> act_online_list = new ArrayList<String>();
		act_online_list.add(getResources().getString(R.string.create_act_on_line));
		act_online_list.add(getResources().getString(R.string.create_act_out_line));
