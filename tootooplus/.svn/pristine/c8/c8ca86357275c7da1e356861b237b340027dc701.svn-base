	...
	private void init(){
		...
		two_or_one_btn_head_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent back_to_mobile_login_intent = new Intent(MobileForgetPwdActivity.this, LoginActivity.class);
				back_to_mobile_login_intent.putExtra("bundle", bundle);
				startActivity(back_to_mobile_login_intent);
				finish();
			}
		});
