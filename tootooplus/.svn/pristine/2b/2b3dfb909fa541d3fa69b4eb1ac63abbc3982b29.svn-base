...
/**
 * 
* @ClassName: HotFreeFragment 
* @Description: 推荐评论
* @author wuyulong
* @date 2015-4-17 上午10:00:07 
*
 */
public class RecommendFreeFragment extends GroupFreeCommentFragment {

	@Override
	public void setDifferentParam(RequestParamsNet requestParamNet) {
		requestParamNet.addQueryStringParameter(TootooeNetApiUrlHelper.TYPE, "3");//1是最新，2 最热，3是推荐
