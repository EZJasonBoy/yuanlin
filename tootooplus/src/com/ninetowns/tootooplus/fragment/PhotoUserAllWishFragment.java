...
import com.ninetowns.tootooplus.adapter.GridViewPhotoAdapter;
import com.ninetowns.tootooplus.application.TootooPlusApplication;
import com.ninetowns.tootooplus.bean.GridViewPhotoBean;
import com.ninetowns.tootooplus.helper.SharedPreferenceHelper;
import com.ninetowns.tootooplus.helper.TootooeNetApiUrlHelper;
import com.ninetowns.tootooplus.parser.PhotoWishParser;
 ...
 * 
 */
public class PhotoUserAllWishFragment extends
	...
	public PhotoUserAllWishFragment(View viewDissMiss,String storyid) {
	...
	public RequestParamsNet getApiParmars() {
		...
		requestPar.setmStrHttpApi(TootooeNetApiUrlHelper.PHOTO_WISH_LIST);
		requestPar.addQueryStringParameter(TootooeNetApiUrlHelper.STORYID,storyid);
