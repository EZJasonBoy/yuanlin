...
/**
 * 
* @ClassName: NewFreeFragment 
* @Description: 最新评论
* @author wuyulong
* @date 2015-4-17 上午10:00:07 
*
 */
public class NewFreeFragment extends GroupFreeCommentFragment {

	@Override
	public void setDifferentParam(RequestParamsNet requestParamNet) {
		requestParamNet.addQueryStringParameter(TootooeNetApiUrlHelper.TYPE, "1");//1是最新
