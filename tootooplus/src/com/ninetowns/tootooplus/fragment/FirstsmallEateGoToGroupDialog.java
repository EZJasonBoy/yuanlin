 ...
 * 
 */
public class FirstsmallEateGoToGroupDialog extends BaseFragmentDialog {
	private View firstGuideGotoGroupView;
	@ViewInject(R.id.rl_dismiss)
	private RelativeLayout mRLDismiss;
	public FirstsmallEateGoToGroupDialog() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		firstGuideGotoGroupView = inflater.inflate(
				R.layout.first_guide_smallgotogroup, null);
	...
	public void dismissView(View v) {
		dismiss();
		SharedPreferenceHelper.setNoFirstGuideSmallGoToGroup(getActivity());
	}
}
