...
/**
 * 
 * @ClassName: MyActDownLineCommentFragment
 * @Description: 线下已经参加、未点评、已经点评 附着界面
 * @author wuyulong
 * @date 2015-4-16 下午2:16:52
 * 
 */
public class MyActDownLineCommentFragment extends GroupFragment implements
	...
	protected Class<? extends Fragment> getPrimaryFragmentClass(int fragmentId) {
		...
		case R.id.rb_act_tab_join:
			calzz = JoinDownLineActFragment.class;
			break;
		case R.id.rb_tab_act_no_comment:
			calzz = NoCommentDownLineActFragment.class;
			break;
		case R.id.rb_tab_act_commented:
			calzz = CommentedDownLineActFragment.class;
