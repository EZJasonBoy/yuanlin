			...
			if (obj.has("Status") && obj.getString("Status").equals("1")) {
				if (obj.has("Data")) {
					...
					if(objList.has("ActivityStatus")){
						String actStatus=objList.getString("ActivityStatus");
						activityBean.setActivityStatus(actStatus);
					}
					if(objList.has("Collent")){
						String collent=objList.getString("Collent");
						activityBean.setCollent(collent);
