...
import com.ninetowns.tootooplus.fragment.CommentFreePageFragment;
import com.ninetowns.tootooplus.fragment.SearchHomePageFragment;
import com.ninetowns.tootooplus.fragment.WishSearchFragment;
	...
	protected Class<? extends Fragment> getPrimaryFragmentClass(int fragmentId) {
		...
		if(!TextUtils.isEmpty(searchType)){
			if(searchType.equals("isWish")){
				...
				clazz =CommentFreePageFragment.class;
			}else {
