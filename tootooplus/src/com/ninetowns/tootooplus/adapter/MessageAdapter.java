...
public class MessageAdapter extends BaseAdapter implements INetConstanst{
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(null==convertView){
			...
			viewHolder.btn_agree= (Button) convertView.findViewById(R.id.mymsgitem_btn_agree);
	...
	* @return void    返回类型 
	*/
	private void agreeActivity(MessageBean messageBean, final Button btn_agree) {
